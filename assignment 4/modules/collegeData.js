...
module.exports.addStudent = function (studentData) {
    return new Promise((resolve, reject) => {
        // Ensure TA is set to false if undefined
        if (studentData.TA === undefined) {
            studentData.TA = false;
        } else {
            studentData.TA = true; // Checkbox sends true if checked
        }

        // Set studentNum property based on current array length + 1
        studentData.studentNum = dataCollection.students.length + 261;

        // Push updated studentData object to students array
        dataCollection.students.push(studentData);

        // Simulate saving to file (you may want to implement actual file saving logic)
